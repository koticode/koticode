...
-- Файлы с самой базой(Base.sql) и с запросами к ней(SQL_requests.sql)  можно загрузить в СУБД и повыполнять запросы. Если СУБД под рукой нет, а нужен доступ к данным таблиц  для ознакомления - таблицы этой БД со всеми данными я экспортировал в отдельные файлы.
